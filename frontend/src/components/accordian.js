...
// const ITEMS_PER_PAGE = 1; // Number of days to display per page

// const AccordionContent = () => {
//   const { courseId } = useParams(); // Fetch courseId from URL parameters
...
//         const courseRef = ref(db, `courses/${courseId}`); // Reference to a specific course in Firebase
...
//   // Formatting function for advanced text
...
//   const daysArray = ["Day 1", "Day 2"]; // Adjust this array according to your course structure if there are more days
...
//         {daysArray.slice(startIndex, startIndex + ITEMS_PER_PAGE).map((day, index) => (
//           <AccordionItem key={index}>
//             <AccordionItemHeading>
//               <AccordionItemButton>{day}</AccordionItemButton>
//             </AccordionItemHeading>
//             <AccordionItemPanel>
//               {/* Render Lectures */}
//               <h2>Lectures</h2>
...
//                   <div dangerouslySetInnerHTML={{ __html: formatMessage(courseData.lectures) }}></div>
//                 </div>
//               ) : (
...
//                   <div dangerouslySetInnerHTML={{ __html: formatMessage(courseData.assignments) }}></div>
//                 </div>
//               ) : (
...
//                   <div dangerouslySetInnerHTML={{ __html: formatMessage(courseData.quizzes) }}></div>
//                 </div>
//               ) : (
...
// const AccordionContent = ({ courseData }) => {
//   const [currentPage, setCurrentPage] = useState(0);
