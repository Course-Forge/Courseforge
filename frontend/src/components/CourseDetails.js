...
// import './CourseDetail.css';  // Optional: Style your page
...
//       <p><strong>Summary:</strong> {courseData.summary ? courseData.summary : 'No summary available.'}</p>

//       {/* Display the full Gemini description */}
